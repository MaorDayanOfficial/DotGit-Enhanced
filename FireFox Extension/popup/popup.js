...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
    if (request.type === "downloadStatus") {
        ...
        if (request.downloadStatus.successful != null) arr[0] = request.downloadStatus.successful.toString();
        if (request.downloadStatus.failed != null) arr[1] = request.downloadStatus.failed.toString();
        if (request.downloadStatus.total != null) arr[2] = request.downloadStatus.total.toString();
